...
export function initRefinePanel(store, actions) {
  ...
  // Song-level reverb/swing/space live in the Shared Atmosphere panel
  // (ui/atmosphere-panel.js) — this module only owns the inspector's per-layer
  // controls and the chord path / journey / seed song controls.
